...
* Download [pre-compiled FontraPak-Ubuntu.tgz](https://github.com/fontra/fontra-pak/releases/latest)
    1. Extract the .tgz with `tar xvf FontraPak-Ubuntu.tgz`
    2. Next add it to your $PATH, or just execute with `./fontrapak`<br/>
